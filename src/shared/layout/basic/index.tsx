            ...
            <div className="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
              ...
              <div className="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                ...
                <div className="dropdown dropdown-end">
                  ...
                  <ul
                    tabIndex={0}
                    className="space-y-2 text-sm dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52"
                  >
                    ...
                    <div className="form-control w-fit">
                      <label className="label cursor-pointer justify-start">
                        ...
                        <span className="label-text ml-2 text-left">Apple (56)</span>
                      </label>
                    </div>
                    <div className="form-control w-fit">
                      <label className="label cursor-pointer justify-start">
                        <input type="checkbox" className="checkbox checkbox-sm" />
                        <span className="label-text ml-2 text-left">Fitbit (56)</span>
                      </label>
                    </div>
                    <div className="form-control w-fit">
                      <label className="label cursor-pointer justify-start">
                        <input type="checkbox" className="checkbox checkbox-sm" />
                        <span className="label-text ml-2 text-left">Dell (56)</span>
                      </label>
                    </div>
                  </ul>
                </div>
